...
//			handleNavbarFixedTop();
	 ...
	 */
	/*-----------------------------------------------------------------------------------*/
	var handleHandsonTables = function () {
		
		var problemId = $('#problemId').val();
		 $.getAlternativeVls(problemId,function(data)
		 {   
			//var container = $('#problemVls');
			var container = document.getElementById('problemVls');
...
//		
//		var data = function () {
//			 // return Handsontable.helper.createSpreadsheetData(4, 4);
//			
//			var data = [
...
//		 $("#load").click(function(){
//			 
//			 $.getAlternativeVls(1,function(data)
//					 {
//				        hot.loadData(data);
//					 });
//			});
//        
	...
	return {
        ...
        init: function () {
			...
			$('#footer_d').append(new Date().getFullYear());
      
        },
        handleTables: function () {
        	handleTables();
        },
        handleHandsonTables: function()
        {
        	handleHandsonTables();
        },
